...
import { Prisma, type MenuCategory } from "@prisma/client/";
...
const RestaurantCategories = ({ restaurant }: RestaurantCategoriesProps) => {
   {/* FUNÇÃO */}
  const [selectedCategory, setSelectedCategory] = useState<MenuCategoriesWithProducts>(restaurant.MenuCategorys[0]);
